...
OUTPUT_CSV = (
    OUTPUT_DIR
    / "independent_olmo2_1b_judge_1000_results.csv"
)

OUTPUT_JSONL = (
    OUTPUT_DIR
    / "independent_olmo2_1b_judge_1000_results.jsonl"
)

CONFIG_JSON = (
    OUTPUT_DIR
    / "independent_olmo2_1b_judge_1000_config.json"
)
...
print("=" * 80)
print("INDEPENDENT OLMo-2 JUDGE - 1000 PROMPTS x 4 MODELS")
print("=" * 80)
...
print("Loading OLMo-2-1124-7B-Instruct in 4-bit...")
